...
import net.MiriaUwU.AnotherTechMod.entity.FabricatorBlockEntity;
...
public class FabricatorMenu extends AbstractContainerMenu {
    ...
    public FabricatorMenu(int containerId, Inventory inv, FriendlyByteBuf extraData) {
    ...
    private static final int TE_INVENTORY_SLOT_COUNT = 3; // 2 inputs + 1 output
    ...
    public boolean stillValid(Player player) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()), player, ModBlocks.Fabricator.get());
    }
